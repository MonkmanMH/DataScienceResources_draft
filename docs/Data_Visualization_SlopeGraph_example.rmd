...
dat <- read_excel("../data/WPP2017_POP_F15_1_ANNUAL_POPULATION_BY_AGE_BOTH_SEXES.xlsx", sheet = "ESTIMATES",
...
Additional wrangling to make 2015 file work
...
dat1_long <- dat1 %>%
  gather(`0-4`:`100+`, key = 'Age_grp', value = 'Pop')
...
#  filter(VarID == 2, Location %in% regions, Time %in% c(2015, 2099)) %>%
  filter(Location %in% regions, Time %in% c(2015, 2099)) %>%
